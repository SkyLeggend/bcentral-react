                ...
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    ...
                    <a
                      ...
                      href="mailto:hola@bcentral.com.mx?subject=Message%20from%20your%20site"
                    >
                      <span className="btn-caption">hola@bcentral.com.mx</span>
                      <i className="ph-bold ph-arrow-up-right" />
                    </a>
                    <p className="inner-headline__text t-large t-bright loading__item">
                    ¿Tienes preguntas? ¡Tenemos las respuestas! Cuéntanos tus ideas y hasta donde quieres llegar, juntos encontraremos el enfoque para explotar tu marca y alcanzar tus objetivos.
                    </p>
                  </div>
                </div>
              </div>
