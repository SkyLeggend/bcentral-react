              ...
              <div className="mxd-hero-01__title-wrap">
                ...
                <div className="mxd-hero-01__images mxd-floating-img">
                  <div className="hero-01-image image-01 mxd-floating-img__item loading__fade">
                    <Image
                      className="mxd-pulse"
                      alt="Hero Image"
                      src="/img/hero/star-hero-home-ye.webp"
                      width={700}
                      height={687}
                    />
                  </div>
                  <div className="hero-01-image image-02 mxd-floating-img__item loading__fade">
                    <Image
                      className="mxd-move"
                      alt="Hero Image"
                      src="/img/hero/heart-hero-home-bcentral.png"
                      width={700}
                      height={798}
                    />
                  </div>
                  <div className="hero-01-image image-03 mxd-floating-img__item loading__fade">
                    <Image
                      ...
                      alt="Hero Image"
                      src="/img/hero/star-hero-bcentral.webp"
                      width={700}
                      height={704}
                    />
                  </div>
                ...
                <h1 className="hero-01-title">
                  <span className="hero-01-title__row loading__item">
                    <em className="hero-01-title__item">Somos</em>
                  ...
                  <span className="hero-01-title__row loading__item">
                    ...
                    <em className="hero-01-title__item">creamos historias</em>
                  </span>
                </h1>
              </div>
            </div>
            ...
            <div className="mxd-hero-01__bottom">
              <div className="mxd-hero-01__data-wrap">
                ...
                <div className="mxd-hero-01__data-btn loading__fade">
                  ...
                  >
                      ...
                      <g>
                        ...
                        <text>
                          ...
                          <textPath xlinkHref="#textPath">
                            Be Different * Be Strategic * Be Unique * BCentral * bc *
                          </textPath>
                        </text>
                      </g>
                    </AnimateRotation>
                    ...
                    <Image
                      ...
                      alt="Object"
                      src="/img/hero/monograma-bcentral-svg.svg"
                      width={300}
                      height={300}
                    />
                  </a>
                ...
                <div className="mxd-hero-01__data-descr loading__fade">
                  <p className="t-bright"> Transformamos tus ideas en historias impactantes que conectan con tu audiencia y generan valor.
                  Expertos en crear alianzas estratégicas que posicionan y potencian tu marca.
